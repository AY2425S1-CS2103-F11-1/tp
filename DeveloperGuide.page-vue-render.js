...
with(this){return _c('ul',[_c('li',[_v("Tech-savvy Tutors/Tuition Teachers")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("****")])]),_v(" "),_c('td',[_v("TA with multiple students")]),_v(" "),_c('td',[_v("add a new student")]),_v(" "),_c('td',[_v("store important data about my students")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("****")])]),_v(" "),_c('td',[_v("TA with multiple students")]),_v(" "),_c('td',[_v("view my students")]),_v(" "),_c('td',[_v("see who is in my class")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("****")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("delete a student's information")]),_v(" "),_c('td',[_v("remove students who are no longer part of my class")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("****")])]),_v(" "),_c('td',[_v("TA having many classes")]),_v(" "),_c('td',[_v("add assignments")]),_v(" "),_c('td',[_v("track assignments for students")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("****")])]),_v(" "),_c('td',[_v("TA having many classes")]),_v(" "),_c('td',[_v("add an assignment score to a student")]),_v(" "),_c('td',[_v("grade my students")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("****")])]),_v(" "),_c('td',[_v("TA having many classes")]),_v(" "),_c('td',[_v("view assignments")]),_v(" "),_c('td',[_v("have an overview of the assignments")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("****")])]),_v(" "),_c('td',[_v("TA having many classes")]),_v(" "),_c('td',[_v("delete assignments")]),_v(" "),_c('td',[_v("remove old assignments")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("****")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("save data locally")]),_v(" "),_c('td',[_v("access them at a later time")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("****")])]),_v(" "),_c('td',[_v("TA who grades assignments")]),_v(" "),_c('td',[_v("edit status of submitted assignments")]),_v(" "),_c('td',[_v("keep track if a student has submitted an assignment")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("***")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("create remark for individual students")]),_v(" "),_c('td',[_v("not forget any special consideration for certain students")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("***")])]),_v(" "),_c('td',[_v("TA having many classes")]),_v(" "),_c('td',[_v("add a class")]),_v(" "),_c('td',[_v("tag students to be part of a class")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("***")])]),_v(" "),_c('td',[_v("TA having many classes")]),_v(" "),_c('td',[_v("delete a class")]),_v(" "),_c('td',[_v("remove old/expired classes")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("***")])]),_v(" "),_c('td',[_v("TA with multiple classes")]),_v(" "),_c('td',[_v("tag students within the same class")]),_v(" "),_c('td',[_v("sort deliverables and progress by tags")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("***")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("edit class groups")]),_v(" "),_c('td',[_v("keep an up-to-date list of students in each group")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("***")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("edit assignments")]),_v(" "),_c('td',[_v("ensure that the assignments are up to date")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("***")])]),_v(" "),_c('td',[_v("TA having multiple classes")]),_v(" "),_c('td',[_v("tag an assignment to a class")]),_v(" "),_c('td',[_v("know which classes have which assignments")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("***")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("view my student's contact information")]),_v(" "),_c('td',[_v("know how I can contact them if there are any issues")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("***")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("view student submissions for a class")]),_v(" "),_c('td',[_v("know who has submitted")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("***")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("view my class timetable")]),_v(" "),_c('td',[_v("know when my classes are")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("***")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("view the submission deadlines")]),_v(" "),_c('td',[_v("know when to remind my students")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("***")])]),_v(" "),_c('td',[_v("forgetful TA")]),_v(" "),_c('td',[_v("be reminded on deadlines due in 2 days")]),_v(" "),_c('td',[_v("prioritize which assignments to mark")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("***")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("sort an assignment by score")]),_v(" "),_c('td',[_v("see the best and worst performers")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("**")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("link scanned PDF files (URL) to a student")]),_v(" "),_c('td',[_v("keep track of previous assignments for each student")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("**")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("view all the files (or just file names) submitted by the student before")]),_v(" "),_c('td',[_v("not waste time finding them somewhere else")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("**")])]),_v(" "),_c('td',[_v("TA who wants to improve grades")]),_v(" "),_c('td',[_v("compare average student performance between sections or classes")]),_v(" "),_c('td',[_v("know which teaching methods are most effective")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("**")])]),_v(" "),_c('td',[_v("TA who wants to improve grades")]),_v(" "),_c('td',[_v("create a priority list of students who need the most attention")]),_v(" "),_c('td',[_v("allocate my time effectively")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("view a student's attendance history")]),_v(" "),_c('td',[_v("mark their attendance scores throughout the whole semester")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("TA")]),_v(" "),_c('td',[_v("mark attendance and manage participation marks for different students in real time")]),_v(" "),_c('td',[_v("not need to update from paper every time")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TAchy")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TA")]),_v(" (Teaching Assistant),\nunless specified otherwise)")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to add a student")])]),_v(" "),_c('li',[_c('p',[_v("TAchy adds the student to the student list")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The student name is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. TAchy shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The student name already exists.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. TAchy shows a list of students with the same name in order of adding time.")])]),_v(" "),_c('li',[_c('p',[_v("1b2. TA adds a note for the student to distinguish them.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to delete a student")])]),_v(" "),_c('li',[_c('p',[_v("TAchy deletes the student from the student list")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The student name is not in the list.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. TAchy displays a \"no students found\" message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1a. There are multiple students with the name.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. TAchy shows a list of students with the same name with indices.")])]),_v(" "),_c('li',[_c('p',[_v("1a2. TA deletes one of them by index.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to list students.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy displays the list of students in the current class.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. No students found in the class.\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. TAchy displays a \"no students\" message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to search for a student by name.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy displays the student(s) matching the search query.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to add an assignment to a class.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy adds the assignment to the class assignment list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. The assignment name is invalid.\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. TAchy shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to delete an assignment.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy removes the assignment from the class assignment list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. No assignment matched the name.\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. TAchy displays a \"this assignment does not exist\" message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: View assignments")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to view the list of assignments.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy displays the list of assignments for the class.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. No assignments are found for the class.\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. TAchy displays a \"no assignments found\" message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to add a grade for a student’s assignment.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy records the grade for the student’s assignment.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The assignment is not found.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. TAchy shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The student is not found.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. TAchy shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1c. The grade is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1c1. TAchy shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1d. The student has already been graded for the assignment.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1d1. TAchy shows a warning message.")])]),_v(" "),_c('li',[_c('p',[_v("1d2. TAchy asks if the TA wants to overwrite the grade.")])]),_v(" "),_c('li',[_c('p',[_v("1d3. TA confirms the overwrite.")])]),_v(" "),_c('li',[_c('p',[_v("1d4. TAchy records the new grade.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: View student submissions for an assignment")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to list all assignments.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy displays the list of assignments.")])]),_v(" "),_c('li',[_c('p',[_v("TA requests to view submission status for an assignment by index.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy displays the list of submissions for the selected assignment.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. No assignments are found for the class.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. TAchy displays a \"no assignments found\" message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("3a. The assignment index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. TAchy shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("4a. No submissions are found for the assignment.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("4a1. TAchy displays a \"no submissions found\" message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Add class")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to add a new class.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy adds the class to the course list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. The class already exists.\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. TAchy shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Delete class")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to delete a class.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy removes the class from the course list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. The class does not exist.\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. TAchy shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: View class timetable")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to view the class timetable.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy displays the class timetable for the current term.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Tag students in a class")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to list all students.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy displays the list of students.")])]),_v(" "),_c('li',[_c('p',[_v("TA requests to tag a student or group of students by index with the current class.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy adds the tags to the students.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. No students found in the class.\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. TAchy displays a \"no students\" message.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li')])]),_v(" "),_c('li',[_v("3a. The student index is invalid.\n"),_c('ul',[_c('li',[_c('p',[_v("3a1. TAchy shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to sort students by the score of an assignment.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy sorts the assignment results by score in ascending or descending order.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. The assignment does not exist.\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. TAchy shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_v("1b. The assignment has not been graded for all students.\n"),_c('ul',[_c('li',[_c('p',[_v("1b1. TAchy shows a warning message.")])]),_v(" "),_c('li',[_c('p',[_v("1b2. TAchy asks if the TA wants to proceed.")])]),_v(" "),_c('li',[_c('p',[_v("1b3. TA confirms the action.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_v("1c. The assignment has not been graded for any student.\n"),_c('ul',[_c('li',[_c('p',[_v("1c1. TAchy shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to list all documents stored in a file directory.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy displays the list of documents.")])]),_v(" "),_c('li',[_c('p',[_v("TA requests to link a document to a student by index by name.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy records the link.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. No documents found in the directory.\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. TAchy displays a \"no documents found\" message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_v("3a. The student name is not in the list.\n"),_c('ul',[_c('li',[_c('p',[_v("3a1. TAchy displays a \"no students found\" message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_v("3b. There are multiple students with the name.\n"),_c('ul',[_c('li',[_c('p',[_v("3b1. TAchy shows a list of students with the same name with indices.")])]),_v(" "),_c('li',[_c('p',[_v("3b2. TA links the document to one of them by index.")]),_v(" "),_c('p',[_v("Use case resumes at step 4.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: View professor contact information")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to view a professor’s contact information.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy displays the professor’s contact details.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: View professor’s office hours")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to view the time and location of a professor’s office hours.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy displays the professor’s office hours and location.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Compare class performance for an assignment")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to list all assignments.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy displays the list of assignments.")])]),_v(" "),_c('li',[_c('p',[_v("TA selects one assignment by index.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy displays the class in order of performance for the selected assignment.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. No assignments are found.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. TAchy displays a \"no assignments found\" message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("3a. The assignment index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. TAchy shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to list students")])]),_v(" "),_c('li',[_c('p',[_v("TA requests to create a list of students who need the most attention by indices.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy generates a list of selected students.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: View or add files posted by professor")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to view or add files posted by the professor for a class.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy displays or allows files to be added to the class.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Mark attendance and manage participation")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to list all classes.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy displays the list of classes.")])]),_v(" "),_c('li',[_c('p',[_v("TA selects one class by index.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy displays the list of students in the class.")])]),_v(" "),_c('li',[_c('p',[_v("TA requests to mark attendance for a student by index.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy records the attendance.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. No classes are found.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. TAchy displays a \"no classes found\" message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("3a. The class index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. TAchy shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("5a. The student index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("5a1. TAchy shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("TA requests to add a remark for a student.")])]),_v(" "),_c('li',[_c('p',[_v("TAchy records the remark in the student’s profile.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The student is not found.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. TAchy shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The student already has a remark.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. TAchy shows a warning message.")])]),_v(" "),_c('li',[_c('p',[_v("1b2. TAchy asks if the TA wants to overwrite the remark.")])]),_v(" "),_c('li',[_c('p',[_v("1b3. TA confirms the overwrite.")])]),_v(" "),_c('li',[_c('p',[_v("1b4. TAchy records the new remark.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("TA")]),_v(" : Abbreviation of Teaching Assistant, a student responsible for assisting instructors in managing courses")]),_v(" "),_c('li',[_c('strong',[_v("Class")]),_v(": A group of students taking the same course assigned to a specific tutorial, sectional, laboratory or recitation which a TA is responsible for.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Thu, 10 Oct 2024, 19:51:13 GMT+8]")])])])}
}];
